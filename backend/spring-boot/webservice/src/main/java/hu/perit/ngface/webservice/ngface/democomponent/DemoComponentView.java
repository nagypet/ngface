...
public class DemoComponentView implements ComponentView
{
    ...
    public Form getForm()
    {
        return new Form("demo-form")
            ...
            .addWidget(new NumericInput(DemoComponentDTO.PRICE_ID)
                .label("Unit price")
            ...
            .addWidget(new Select(DemoComponentDTO.SELECT3_ID)
                .label("Select")
                .data(this.data.getSelect3Data())
                .placeholder("Select an option!")
                .hint("First option is default")
            )
            .addWidget(new Autocomplete(DemoComponentDTO.AUTOCOMPLETE_ID)
                .label("Autocomplete")
            ...
            .addWidget(new Autocomplete(DemoComponentDTO.AUTOCOMPLETE_STREETS_ID)
                .label("Street")
