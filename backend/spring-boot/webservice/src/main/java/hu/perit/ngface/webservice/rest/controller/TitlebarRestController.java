...
import hu.perit.ngface.webservice.ngface.titlebarcomponent.TitlebarComponentView;
...
@RestController
@RequestMapping("/frontend/forms/demo/titlebar")
public class TitlebarRestController
{
    @GetMapping
    @LoggedRestMethod(eventId = Constants.TITLEBAR_CONTROLLER_GET_FORM, subsystem = Constants.SUBSYSTEM_NAME)
