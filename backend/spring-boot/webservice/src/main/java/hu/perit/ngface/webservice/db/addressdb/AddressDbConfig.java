...
package hu.perit.ngface.webservice.db.addressdb;
...
@EnableJpaRepositories(basePackages = AddressDbConfig.PACKAGES,
    entityManagerFactoryRef = AddressDbConfig.ENTITY_MANAGER_FACTORY,
    transactionManagerRef = AddressDbConfig.TRANSACTION_MANAGER)
@Slf4j
public class AddressDbConfig
{
    static final String PACKAGES = "hu.perit.ngface.webservice.db.addressdb";
    public static final String ENTITY_MANAGER_FACTORY = "entityManagerFactory";
    static final String TRANSACTION_MANAGER = "transactionManager";

    public static final String PERSISTENCE_UNIT = "addressdb";
    private static final String DATASOURCE = "dataSource";

    private final ConnectionParam connectionParam;


    public AddressDbConfig(DatasourceCollectionProperties dbProperties)
    {
