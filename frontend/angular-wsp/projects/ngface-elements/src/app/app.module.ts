...
import {NgfaceButtonComponent} from '../../../ngface/src/lib/ngface-button/ngface-button.component';
import {createCustomElement} from '@angular/elements';
import {NgfaceModule} from '../../../ngface/src/lib/ngface.module';
import {NgfaceDataTableComponent} from '../../../ngface/src/lib/ngface-data-table/ngface-data-table.component';
import {NgfaceDateInputComponent} from '../../../ngface/src/lib/ngface-date-input/ngface-date-input.component';
import {NgfaceDateRangeInputComponent} from '../../../ngface/src/lib/ngface-date-range-input/ngface-date-range-input.component';
import {NgfaceTextInputComponent} from '../../../ngface/src/lib/ngface-text-input/ngface-text-input.component';
import {NgfaceNumericInputComponent} from '../../../ngface/src/lib/ngface-numeric-input/ngface-numeric-input.component';
import {NgfaceSelectComponent} from '../../../ngface/src/lib/ngface-select/ngface-select.component';
import {AppComponent} from './app.component';
import {NgfaceFormComponent} from '../../../ngface/src/lib/ngface-form/ngface-form.component';
